  ...
  <body>
    <div id="headBar">
    	<div id="headBar_Controler">
    		<div id="headBar_left">
    			<span id="pageTag">华为专栏</span>
    			<span class="headBar_left_spanLag">|</span>
    			<a class="headBar_left_aLag" href="http://www.huawei.com/cn/">华为集团</a>
    			<span class="headBar_left_spanLag">|</span>
    			<a class="headBar_left_aLag" href="https://www.vmall.com/?cid=10074">华为商城</a>
    			<span class="headBar_left_spanLag">|</span>
    			<a class="headBar_left_aLag" href="https://consumer.huawei.com/cn/">华为消费者业务</a>
    			<span class="headBar_left_spanLag">|</span>
    ...
    <div id="titleBar">
    	<div id="titleBar_controler">
    		<div id="miIcon">
    			<a id="huaweiIcon_aTag" href="http://www.huawei.com/cn/">
    				<img src="digoMainPage_pic/huawei_logo.png" alt="华为官网" title="华为官网">
    			</a>
    		</div>
    	...
    	<div id="showProdust_controler">
	    	<div id="productList">
	    		<ul>
	    			<li id="li1" class=productList_li>
	    				<a href="getGoods?SId=104"><font class="productList_li_font">华为P1&nbsp;&nbsp;&emsp;></font></a>
	    			</li>
	    			<li id="li2" class=productList_li>
	    				<a href="getGoods?SId=104"><font class="productList_li_font">华为P2&nbsp;&nbsp;&emsp;></font></a>
	    			</li>
	    			<li id="li3" class=productList_li>
	    				<a href="getGoods?SId=104"><font class="productList_li_font">华为P3&nbsp;&nbsp;&emsp;></font></a>
	    			</li>
	    			<li id="li4" class=productList_li>
	    				<a href="getGoods?SId=104"><font class="productList_li_font">华为P4&nbsp;&nbsp;&emsp;></font></a>
	    			</li>
	    			<li id="li5" class=productList_li>
	    				<a href="getGoods?SId=104"><font class="productList_li_font">华为P5&nbsp;&nbsp;&emsp;></font></a>
	    			</li>
	    			<li id="li6" class=productList_li>
	    				<a href="getGoods?SId=104"><font class="productList_li_font">华为P6&nbsp;&nbsp;&emsp;></font></a>
	    			</li>
	    			<li id="li7" class=productList_li>
	    				<a href="getGoods?SId=104"><font class="productList_li_font">华为P7&nbsp;&nbsp;&emsp;></font></a>
	    			</li>
	    			<li id="li8" class=productList_li>
	    				<a href="getGoods?SId=104"><font class="productList_li_font">华为P8&nbsp;&nbsp;&emsp;></font></a>
	    			</li>
	    			<li id="li9" class=productList_li>
	    				<a href="getGoods?SId=104"><font class="productList_li_font">华为P9&nbsp;&nbsp;&emsp;></font></a>
	    			</li>
	    			<li id="li10" class=productList_li>
	    				<a href="getGoods?SId=104"><font class="productList_li_font">华为P10&nbsp;&nbsp;&emsp;></font></a>
	    			</li>
	    			<li id="li11" class=productList_li>
	    				<a href="getGoods?SId=104"><font class="productList_li_font">华为P11&nbsp;&nbsp;&emsp;></font></a>
	    			</li>
	    		</ul>
	    	</div>
	    	...
	    	<div id="productPicSlide">
	    		...
	    		<a class="productPicSlide_aTag" id="productPicSlide_aTag1" href="getGoods?SId=104">
	    			<img class="picSlide_img" id="img1" style="display: block;" src="digoMainPage_pic/mate10.jpg" alt="mate10" title="mate10">
	    		</a>
	    		<a class="productPicSlide_aTag" id="productPicSlide_aTag2" href="getGoods?SId=104">	
	    			<img class="picSlide_img" id="img2" style="display: block;" src="digoMainPage_pic/mateRS.jpg" alt="mateRS" title="mateRS">
	    		</a>
	    		<a class="productPicSlide_aTag" id="productPicSlide_aTag3" href="getGoods?SId=104">
	    			<img class="picSlide_img" id="img3" style="display: block;" src="digoMainPage_pic/P20.jpg" alt="P20" title="P20">
	    		</a>
	    		<a class="productPicSlide_aTag" id="productPicSlide_aTag4" href="getGoods?SId=104">	
	    			<img class="picSlide_img" id="img4" style="display: block;" src="digoMainPage_pic/cx6s.jpg" alt="畅享6s" title="畅享6s">
	    		</a>
	    	</div>
    	</div>
    </div>
